...
let goods2 = new Goods('apple',2400,"anchor",4,".out-4");
goods2.draw();
 //Task 5.
...
let goods3 = new Goods2("Orange", 1234,"api",12,".out-6","true");
goods3.drawSale();
...
console.log(val.isValid);
 ...
 let val2 = new Valid("hj@ruer","1234567");
 val2.validate();
 ...
 let valid2 = new Valid2('','dыаваsds');
 valid2.validateNew();
 console.log(valid2.isValid);
 console.log(valid2.passwordError);
 console.log(valid2.emailError);
 //Task 12.
 ...
 let valid3 = new Valid2('dd','dыаваsds');
 valid3.validateNew();
 console.log(valid3.isValid);
 console.log(valid3.passwordError);
 console.log(valid3.emailError);