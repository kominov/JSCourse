...
let ar1 = [32, "string", true, false];// переменную обьявляем здесь!!!!
...
function f5() {
    document.querySelector('.out-5').innerHTML = ar5[0] + ar5[2] + ar4[3];
}
...
function f16() {
    ...
    for (let i = 0; i < ar16.length; i++) {
        if (ar16[i] % 2 === 0) {
            ...
            ar16_even[count1] = ar16[i] + ' ';
            count1++;
        }
        else {
            ar16_odd[count2] = ar16[i] + ' ';
            count2++;
        }
    }
...
function f19() {
    ...
    document.querySelector('.out-19').innerHTML = count;
}
