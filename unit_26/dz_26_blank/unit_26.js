...
let query = {
    ...
    action1: "action=1",
    action2: "action=2&name=mikhail",
    action3: "action=3&num1=3&num2=7",
    action4: "action=4&num1=3&num2=7",
    action5: "action=5",
    action6: "action=6&num1=3&num2=10",
    action7: "action=7",
    action8: "action=8&year=1989",
    action9: "action=9&m=1&d=1&y=1",
}
function fetchRequery(auth, action, out) {
    fetch(`http://getpost.itgid.info/index2.php?${auth}${action}`)
        .then(resp => resp.text())
        .then(resp => {
            document.querySelector(out).innerHTML = resp;
        })
}
function postFetchRequery(action, out) {
    let auth = `auth=DdC33D7d2C2a7&`;
    fetch(`http://getpost.itgid.info/index2.php`, {
        ...
        body: auth + action,// body data type must match "Content-Type" header
    })
    .then(resp => resp.text())
    .then(resp =>{
        document.querySelector(out).innerHTML = resp;
...
function t1() {
    fetchRequery(query.auth, query.action1, '.out-1');
}
...
function t2() {
    fetchRequery(query.auth, query.action2, ".out-2")
}
...
function t3() {
    fetchRequery(query.auth, query.action3, ".out-3")
}
...
function t4() {
    fetchRequery(query.auth, query.action4, ".out-4")
}
...
function t5() {
    fetchRequery(query.auth, query.action5, ".out-5")
}
...
function t6() {
    fetchRequery(query.auth, query.action6, ".out-6")
}
...
function t7() {
    fetchRequery(query.auth, query.action7, ".out-7")
}
...
function t8() {
    fetchRequery(query.auth, query.action8, ".out-8")
}
...
function t9() {
    fetchRequery(query.auth, query.action9, ".out-9")
}
...
function t10() {
    postFetchRequery(query.action1,'.out-10');
}
...
function t11() {
    postFetchRequery(query.action2,'.out-11');
}
...
function t12() {
    postFetchRequery(query.action3,'.out-12');
}
...
function t13() {
    postFetchRequery(query.action4,'.out-13');
}
...
function t14() {
    postFetchRequery(query.action5,'.out-14');
}
...
function t15() {
    postFetchRequery(query.action6,'.out-15');
}
...
function t16() {
    postFetchRequery(query.action7,'.out-16');
}
...
function t17() {
    postFetchRequery(query.action8,'.out-17');
}
...
function t18() {
    postFetchRequery(query.action9,'.out-18');
}
