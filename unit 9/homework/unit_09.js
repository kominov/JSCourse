...
function f5() {
    const out4 = document.querySelector('.out-4');
    document.querySelector('.out-5').innerHTML = out4.classList.contains('bg-4');
}
...
function f18() {
    let num = document.querySelector('.p-18').getAttribute('data-b');
...
function f19() {
    ...
    for (let i=0;i<p.length;i++){
        result += p[i].getAttribute("data-b") + " ";
    }
