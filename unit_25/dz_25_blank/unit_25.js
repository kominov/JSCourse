...
function getRequest(request,out) {
    const xtr = new XMLHttpRequest();
    xtr.open('GET', `http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7${request}`);
    xtr.send();
    xtr.onreadystatechange = function() {
        if(this.readyState ===4 && this.status ===200)document.querySelector(out).innerHTML = this.responseText;
    }
}

function postRequest(request,out) {
    const xtr2 = new XMLHttpRequest();
    xtr2.open('POST', 'http://getpost.itgid.info/index2.php');
    xtr2.setRequestHeader('Content-type', 'application/x-www-form-urlencoded');
...
function t2() {
    getRequest("&action=2&name=mikhail",".out-2");
}
...
function t3() {
    getRequest("&action=3&num1=4&num2=5",".out-3");
}
...
function t4() {
    getRequest("&action=4&num1=1&num2=9",".out-4");
}
...
function t6() {
    getRequest("&action=6&num1=1&num2=9",".out-6");
}
...
function t8() {
    getRequest("&action=8&year=1989",".out-8");
}
...
function t9() {
    getRequest("&action=9&m=1&d=1&y=1",".out-9");
}
...
function t10() {
    postRequest('auth=DdC33D7d2C2a7&action=1','.out-10');
}
...
function t11() {
    postRequest('auth=DdC33D7d2C2a7&action=2&name=mikhail','.out-11');
}
...
function t12() {
    postRequest('auth=DdC33D7d2C2a7&action=3&num1=1&num2=19','.out-12');
}
...
function t13() {
    postRequest('auth=DdC33D7d2C2a7&action=4&num1=1&num2=19','.out-13');
}
...
function t14() {
    postRequest('auth=DdC33D7d2C2a7&action=5','.out-14');
}
...
function t15() {
    postRequest('auth=DdC33D7d2C2a7&action=6&num1=1&num2=19','.out-15');
}
...
function t16() {
    postRequest('auth=DdC33D7d2C2a7&action=7','.out-16');
}
...
function t17() {
    postRequest('auth=DdC33D7d2C2a7&action=8&year=1989','.out-17');
}
...
function t18() {
    postRequest('auth=DdC33D7d2C2a7&action=9&m=1&d=1&y=1','.out-18');
}
