...
document.querySelector('.three').innerHTML = "<h3> Any Text</h3>";
...
document.querySelector('.four').innerHTML += " <h3>Header</h3>" + "<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Laudantium sed, sint in itaque natus veniam, molestias perspiciatis libero dicta, fugit illo non dolorem saepe ea officia rerum blanditiis facilis suscipit!</p>"
...
let y1=6, y2=3;
 document.querySelector('.division-15').innerHTML = y1/y2;
...
let x1 = 'Hello', x2 = 5;
document.querySelector('.addition-16').innerHTML = x1+x2;
