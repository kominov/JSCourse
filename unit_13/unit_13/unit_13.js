...
function f6() {
    let inpt1 = document.querySelector('.i-61').value;
    let inpt2 = document.querySelector('.i-62').value;
    a6[inpt1] = inpt2;
    f5(a6, '.out-6');
}
...
function f8() {
    out = 0;
    let inpt = document.querySelector('.i-8').value;
    for (let key in a8) {
        if (key === inpt) {
            out += a8[key];
            break
...
function f9() {
    let inpt = +document.querySelector('.i-9').value,
        out = '';
    for (let key in a9) {
        if (a9[key] === inpt) {
            out += `${key} `;
...
function f11() {
    let inpt = document.querySelector('.i-11').value;
    for (let key in a11) {
        if (key == inpt) delete a11[key];
    }
    f5(a11, ".out-11");
}
...
function f12() {
    let inpt = document.querySelector('.i-12').value;
    for (let key in a12) {
        if (a12[key] == inpt) delete a12[key];
    }
    f5(a12, ".out-12");
}
...
function f18() {
    let out = '';
    let subLine = document.querySelector('.i-18').value;
    for (let key in a18) {
...
function f19() {
    let out = '';
    let subLine = document.querySelector('.i-19').value;
    for (let key in a19) {
        for (let i = 0; i < a19[key].length; i++) {
            if (a19[key][i].toUpperCase() == subLine.toUpperCase()) {
                out += key;
                break;
            }
        }
