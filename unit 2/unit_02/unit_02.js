...
document.querySelector('.out-8').value = 0;
document.querySelector('.button-primary').onclick = function () {
    let out8 = document.querySelector('.out-8').value;
    console.log(out8);
}
...
function t9() {
    let out9 = document.querySelector('.i-9').value;
...
function t10() {
    let out10 = document.querySelector('.i-10').value;
    document.querySelector('.out-10').innerHTML = out10 * 2;
...
function t11() {
    ...
    // console.log(typeof(+input11));
    document.querySelector('.out-11').innerHTML = +input11 + 10;
...
function t12() {
    let firstName = document.querySelector('.i-12_1').value;
    let secondName = document.querySelector('.i-12_2').value;
    // let ggg = firstName + secondName;
    // console.log(ggg);
    document.querySelector('.out-12').innerHTML += "Hellow, " + firstName + ' ' + secondName;
}
...
function t13() {
    ...
    let numbOne = document.querySelector('.i-13_1').value;
    let numbTwo = document.querySelector('.i-13_2').value;
    document.querySelector('.out-13').innerHTML += +numbOne + +numbTwo;
...
function t16() {
    ...
    document.querySelector('.out-16').innerHTML = +i1 + +i2;
}
...
function t17() {
    ...
    document.querySelector('.out-17').innerHTML = parseInt(t, 2);
...
function t19() {
    ...
    let i1 = document.querySelector('.i-19-1').value;
    let i2 = document.querySelector('.i-19-2').value;
    document.querySelector('.out-19').innerHTML += parseInt(+i1 + +i2);
}
...
function t20() {
    ...
    let secondName = document.querySelector('.i-20-2').value;
    let age = document.querySelector('.i-20-3').value;
    let profession = document.querySelector('.i-20-4').value;
    document.querySelector('.out-20').innerHTML = 'Уважаемый ' + name + ' ' + secondName + ', ваш возраст ' + age + ' года, по професси вы ' + profession;
}
