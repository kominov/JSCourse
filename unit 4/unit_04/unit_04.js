...
function f4() {
    let checkBox = document.querySelector('.i-4').checked;
    document.querySelector('.out-4').innerHTML = checkBox;
}
...
function f5() {
    let chkBox = document.querySelector('.i-5');

    if (chkBox.checked) {
        document.querySelector('.out-5').innerHTML = chkBox.value;
    }
    else {
        document.querySelector('.out-5').innerHTML = chkBox.checked;
    }
}
...
function f6() {
    let hdn = document.querySelector('.i-6').value;
    document.querySelector('.out-6').innerHTML = hdn;
}
...
function f7() {
    let pswrd = document.querySelector('.i-7').value;
    document.querySelector('.out-71').innerHTML = pswrd;
    if (pswrd.length >= 6) {
...
function f8() {
    ...
    out8.innerHTML = "<button class ='batton-primary b-81'> PUSH </button> <input type = 'text'value = '123'  class = 'i-81'>";
...
function f17() {
    ...
    document.querySelector('.out-17').innerHTML = select;
}
...
function f19() {
    ...
    document.querySelector('.out-19').innerHTML += text + ' ' + pass;
}
...
function f20(e) {
    ...
    let usrName = form.elements['username'].value;
    let pass = form.elements['password'].value;
    document.querySelector('.out-20').innerHTML += usrName + ' ' + pass;
}
